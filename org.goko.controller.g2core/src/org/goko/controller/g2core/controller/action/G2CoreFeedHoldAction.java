...
/**
 * Feed hold action for G2Core
 *
 * @author PsyKo
 *
 */
public class G2CoreFeedHoldAction extends AbstractTinyGControllerAction<G2CoreConfiguration, G2CoreControllerService> {

	public G2CoreFeedHoldAction(G2CoreControllerService controllerService) {
