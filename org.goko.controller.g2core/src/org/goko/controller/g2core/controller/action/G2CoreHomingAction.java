...
/**
 * Homing action for G2Core
 *
 * @author PsyKo
 *
 */
public class G2CoreHomingAction extends AbstractTinyGControllerAction<G2CoreConfiguration, G2CoreControllerService> {

	public G2CoreHomingAction(G2CoreControllerService controllerService) {
	...
	public boolean canExecute() throws GkException {
		return ObjectUtils.equals(G2Core.State.READY, getControllerService().getState())
			|| ObjectUtils.equals(G2Core.State.PROGRAM_END, getControllerService().getState())
			|| ObjectUtils.equals(G2Core.State.PROGRAM_STOP, getControllerService().getState());
	}
