...
/**
 * Stop action for G2Core
 *
 * @author PsyKo
 *
 */
public class G2CoreStopAction extends AbstractTinyGControllerAction<G2CoreConfiguration, G2CoreControllerService> {

	public G2CoreStopAction(G2CoreControllerService controllerService) {
	...
	public boolean canExecute() throws GkException {
		return ObjectUtils.equals(G2Core.State.MOTION_RUNNING, getControllerService().getState())
			|| ObjectUtils.equals(G2Core.State.RUNNING, getControllerService().getState())
			|| ObjectUtils.equals(G2Core.State.HOMING, getControllerService().getState())
			|| ObjectUtils.equals(G2Core.State.MOTION_HOLDING, getControllerService().getState())
			|| ObjectUtils.equals(G2Core.State.PROBE_CYCLE, getControllerService().getState());
	}
