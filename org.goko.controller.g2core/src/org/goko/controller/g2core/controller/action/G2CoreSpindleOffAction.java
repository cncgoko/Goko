 ...
 *
 */
public class G2CoreSpindleOffAction extends AbstractTinyGControllerAction<G2CoreConfiguration, G2CoreControllerService> {

	public G2CoreSpindleOffAction(G2CoreControllerService controllerService) {
	...
	public boolean canExecute() throws GkException {
		return !ObjectUtils.equals(G2Core.State.UNDEFINED, getControllerService().getState());//getControllerService().isSpindleOn();
	}
