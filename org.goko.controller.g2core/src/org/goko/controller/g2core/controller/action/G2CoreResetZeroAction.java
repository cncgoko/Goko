...
/**
 * Reset zero action for G2Core
 *
 * @author PsyKo
 *
 */
public class G2CoreResetZeroAction extends AbstractTinyGControllerAction<G2CoreConfiguration, G2CoreControllerService>{

	public G2CoreResetZeroAction(G2CoreControllerService controllerService) {
	...
	public boolean canExecute() throws GkException {
		return !ObjectUtils.equals(G2Core.State.MOTION_RUNNING, getControllerService().getState())
				&& !ObjectUtils.equals(G2Core.State.UNDEFINED, getControllerService().getState());
	}
