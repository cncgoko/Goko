 ...
 * @date 7 juin 2016
 */
public class G2CoreGConfigurationFixDialog extends Dialog {
	 ...
	 * @param parentShell
	 */
	public G2CoreGConfigurationFixDialog(Shell parentShell, String[] fixProposal) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		lblNewLabel.setText("For correct communication between Goko and TinyG, the following parameters should be updated in TinyG Configuration");
