...
/**
 * Counter Clockwise arc rendering
 *
 * @author PsyKo
 *
 */
public class CCWArcGCodeBufferedRenderer extends ArcGCodeBufferedRenderer {

	/**
	 * Constructeur
	 * @param buffer le buffer
	 */
	public CCWArcGCodeBufferedRenderer(Map<Integer, BufferedRenderingData> buffer) {
		super(buffer, false);
	}
