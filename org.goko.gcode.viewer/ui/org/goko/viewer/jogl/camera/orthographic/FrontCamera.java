 ...
 *******************************************************************************/
package org.goko.viewer.jogl.camera.orthographic;
...
public class FrontCamera extends OrthographicCamera implements MouseMoveListener,MouseListener, Listener {	
	public static final String ID = "org.goko.gcode.viewer.camera.orthographic.front";
	...
	/** (inheritDoc)
	 * @see org.goko.viewer.jogl.camera.OrthographicCamera#updatePosition()
	 */
	@Override
	...
	/** (inheritDoc)
	 * @see org.goko.viewer.jogl.camera.OrthographicCamera#panMouse(org.eclipse.swt.events.MouseEvent)
	 */
	@Override
	...
	/** (inheritDoc)
	 * @see org.goko.viewer.jogl.camera.OrthographicCamera#mouseScroll(org.eclipse.swt.widgets.Event)
	 */
	@Override
