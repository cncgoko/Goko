...
public class RotaryAxisAdapter implements IGCodeProviderRenderer{
	...
	/** (inheritDoc)
	 * @see org.goko.viewer.jogl.service.ICoreJoglRenderer#getId()
	 */
	@Override
	public String getId() {
	...
	/** (inheritDoc)
	 * @see org.goko.viewer.jogl.service.ICoreJoglRenderer#render(javax.media.opengl.GL3, com.jogamp.opengl.util.PMVMatrix)
	 */
	@Override
	...
	/** (inheritDoc)
	 * @see org.goko.viewer.jogl.service.ICoreJoglRenderer#setEnabled(boolean)
	 */
	@Override
