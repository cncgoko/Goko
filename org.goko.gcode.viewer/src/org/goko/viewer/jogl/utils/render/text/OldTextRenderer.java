...
public class OldTextRenderer extends DeprecatedAbstractVboJoglRenderer {
	...
	public OldTextRenderer(String text, double size, Point3d position) {
		this(text, size, position, new Vector3d(1,0,0), new Vector3d(0,1,0));
	}

	public OldTextRenderer(String text, double size, Point3d position, int alignement) {
		this(text, size, position, new Vector3d(1,0,0), new Vector3d(0,1,0), alignement);
	}
	public OldTextRenderer(String text, double size, Point3d position, Vector3d widthVector, Vector3d heightVector) {
		this(text, size, position, widthVector, heightVector, CENTER | MIDDLE);
	}

	public OldTextRenderer(String text, double size, Point3d position, Vector3d widthVector, Vector3d heightVector, int alignement) {
		super();
		this.text = text;
