...
import org.goko.core.gcode.rs274ngcv3.jogl.renderer.colorizer.SpindleStateColorizer;

/**
 * @author Psyko
 * @date 19 juil. 2017
 */
public class SpindleStateColorizerHandler {
	...
	public void execute(RS274NGCV3JoglService service){
		try {
			service.changeColorizer(new SpindleStateColorizer());
		} catch (GkException e) {
