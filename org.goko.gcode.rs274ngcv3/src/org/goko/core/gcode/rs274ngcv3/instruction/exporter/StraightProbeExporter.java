...
public class StraightProbeExporter extends AbstractStraightInstructionExporter<StraightProbeInstruction>{
	 ...
	 */
	@Override
	protected List<GCodeWord> getWords(GCodeContext context, StraightProbeInstruction instruction, RenderingFormat format) throws GkException {
		List<GCodeWord> result = wrap(new GCodeWord("G","38.2"));
