...
public class ChangeToolExporter extends AbstractInstructionExporter<ChangeToolInstruction>{

	public ChangeToolExporter() {
	 ...
	 */
	@Override
	protected List<GCodeWord> getWords(GCodeContext context, ChangeToolInstruction instruction, RenderingFormat format) throws GkException {
		return wrap(new GCodeWord("M","6"));
	}
