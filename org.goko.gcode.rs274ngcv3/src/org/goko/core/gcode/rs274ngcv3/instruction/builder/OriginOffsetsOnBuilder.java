...
public class OriginOffsetsOnBuilder extends AbstractInstructionBuilder<OriginOffsetsOnInstruction> {
	 ...
	 */
	@Override
	public OriginOffsetsOnInstruction toInstruction(GCodeContext context, List<GCodeWord> words) throws GkException {
	 ...
	 */
	@Override
	public List<GCodeWord> toGCodeWord(GCodeContext context, OriginOffsetsOnInstruction instruction) throws GkException {
