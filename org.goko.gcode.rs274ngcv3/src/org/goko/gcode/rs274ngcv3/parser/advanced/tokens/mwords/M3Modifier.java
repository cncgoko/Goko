...
public class M3Modifier extends CompleteTokenCommandModifier<FunctionCommand>{
	...
	public void apply(GCodeToken token, FunctionCommand command) throws GkException {
		command.addFunctionType(EnumGCodeCommandFunctionType.TURN_SPINDLE_CLOCKWISE);
	}
