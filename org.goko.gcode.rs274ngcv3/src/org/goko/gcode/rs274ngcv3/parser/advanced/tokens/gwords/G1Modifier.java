...
public class G1Modifier extends CompleteTokenCommandModifier<SettingCommand>{
	...
	public void apply(GCodeToken token, SettingCommand command) throws GkException {
		command.setMotionType(EnumGCodeCommandMotionType.LINEAR);
		command.setMotionMode(EnumGCodeCommandMotionMode.FEEDRATE);
