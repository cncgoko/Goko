...
public class G21Modifier extends CompleteTokenCommandModifier<SettingCommand>{
	...
	public void apply(GCodeToken token, SettingCommand command) throws GkException {
		command.setUnit(EnumGCodeCommandUnit.MILLIMETERS);
		command.setExplicitUnit(true);
	}
