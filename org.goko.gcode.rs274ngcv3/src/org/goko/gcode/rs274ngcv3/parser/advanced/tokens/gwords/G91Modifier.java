...
public class G91Modifier extends CompleteTokenCommandModifier<SettingCommand>{
	...
	public void apply(GCodeToken token, SettingCommand command) throws GkException {
		command.setDistanceMode(EnumGCodeCommandDistanceMode.RELATIVE);
		command.setExplicitDistanceMode(true);
	}
