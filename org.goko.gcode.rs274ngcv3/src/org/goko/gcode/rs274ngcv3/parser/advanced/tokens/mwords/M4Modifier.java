...
public class M4Modifier extends CompleteTokenCommandModifier<FunctionCommand>{
	...
	public void apply(GCodeToken token, FunctionCommand command) throws GkException {
		command.addFunctionType(EnumGCodeCommandFunctionType.TURN_SPINDLE_COUNTERCLOCKWISE);
	}
