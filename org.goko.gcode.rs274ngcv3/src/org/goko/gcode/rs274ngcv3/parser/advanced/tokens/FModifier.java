...
public class FModifier extends LetterTokenCommandModifier<SettingCommand>{
	...
	public void apply(GCodeToken token, SettingCommand command) throws GkException {
		command.setFeedrate(new BigDecimal( RS274.getTokenValue(token) ));
		command.setExplicitFeedrate(true);
	}
