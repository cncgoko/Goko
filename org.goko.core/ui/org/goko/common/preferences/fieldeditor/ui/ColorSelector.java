...
public class ColorSelector extends EventManager {
	...
	public Color3f getColor3f(){
		if(fColorValue != null){
			return new Color3f(fColorValue.red/ 255.0f, fColorValue.green / 255.0f, fColorValue.blue/ 255.0f);	
		}
		return null;
	}
	...
	public void setColor3f(Color3f color){
		if(color != null){
			setColorValue(new RGB( Math.round(color.x * 255), Math.round(color.y * 255), Math.round(color.z * 255)));
		}else{
			setColorValue(new RGB(127,127,127));
		}
