package org.goko.common.preferences.internal;
...
/* */
	...
	/* */
	public static final String PREFS_PAGE_XP = "Goko.org.goko.ui.gkPreferencePage"; // $NON-NLS-1$
	public static final String PREF_STORE_PROVIDER = "Goko.org.goko.ui.gkPreferenceStoreProvider"; // $NON-NLS-1$
...
//					continue;
//				}
				if(psProviders.containsKey(declaringBundle)){
					logger.error("Multiple preference store for a single bundle is not supported yet");
				}
				...
				{
					try{
						String classURI = getClassURI(declaringBundle, elmt.getAttribute(ATTR_CLASS));
						data = factory.create(classURI, context);
				...
				psProviders.put(declaringBundle, data);
