 ...
 */
public class GokoResourceHandler implements IModelResourceHandler {
	 ...
	 */
	@Inject
	public GokoResourceHandler(@Named(IWorkbench.PERSIST_STATE) boolean saveAndRestore,
	...
	public Resource loadMostRecentModel() {
		...
		GokoModelAssembler contribProcessor = ContextInjectionFactory.make(GokoModelAssembler.class, context);
