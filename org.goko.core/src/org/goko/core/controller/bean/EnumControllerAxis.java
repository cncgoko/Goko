...
public enum EnumControllerAxis {
	...
	EnumControllerAxis(String code, String axisLetter, boolean direction){
		this.code = code;
	 ...
	 */
	public static EnumControllerAxis getEnum(String code) throws GkException{
		for(EnumControllerAxis value : EnumControllerAxis.values()){
			if(StringUtils.equals(value.getCode(), code)){
				return value;
			}
		}
		throw new GkTechnicalException("EnumControllerAxis with code '"+code+"' does not exist.");
	}
