...
public interface IGCodeProviderRepository extends IGokoService{
	...
	void addListener(IGCodeProviderRepositoryListener listener, int priority) throws GkException;

	void removeListener(IGCodeProviderRepositoryListener listener) throws GkException;

	void clearAll() throws GkException;

	void addDeleteVetoableListener(IGCodeProviderDeleteVetoableListener listener) throws GkException;
