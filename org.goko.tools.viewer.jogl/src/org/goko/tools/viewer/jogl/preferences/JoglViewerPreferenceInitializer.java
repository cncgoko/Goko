...
public class JoglViewerPreferenceInitializer extends GkPreferenceInitializer{
	...
	public void initializeDefaultGkPreferences() throws GkException {
		...
		prefs.setDefault(JoglViewerPreference.MULTISAMPLING, "16");
		...
		prefs.setDefault(JoglViewerPreference.MAJOR_GRID_COLOR, StringConverter.asString(new RGB(193, 193, 193)));
		prefs.setDefault(JoglViewerPreference.MINOR_GRID_COLOR, StringConverter.asString(new RGB(127, 127, 127)));
		prefs.setDefault(JoglViewerPreference.MAJOR_GRID_OPACITY, 25);
		prefs.setDefault(JoglViewerPreference.MINOR_GRID_OPACITY, 10);
