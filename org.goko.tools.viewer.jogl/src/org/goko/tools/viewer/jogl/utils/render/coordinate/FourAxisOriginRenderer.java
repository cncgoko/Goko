...
public class FourAxisOriginRenderer extends AbstractCoreJoglMultipleRenderer {
	...
	public FourAxisOriginRenderer(boolean displayRotaryAxis) {
		...
		addRenderer(new ArrowRenderer(new Tuple6b(10d, 0d, 0.01, u), new Vector3d(1,0,0), new Vector3d(0,1,0), new Color4f(1,0,0,1)));
		...
		addRenderer(new ArrowRenderer(new Tuple6b(0, 10, 0.01, u), new Vector3d(0,1,0), new Vector3d(1,0,0), new Color4f(0,1,0,1)));
		...
		addRenderer(new ArrowRenderer(new Tuple6b(0, 0, 10, u), new Vector3d(0,0,1), new Vector3d(1,0,0), new Color4f(0,0,1,1)));
	...
	private void addRotaryAxisArrow() {
		...
		if(rotaryAxisDirection == EnumRotaryAxisDirection.X){
			rotaryAxisArrow = new ArrowRenderer(new Tuple6b(0, 5, 0, u), new Vector3d(0,0,-1), new Vector3d(0,1,0), new Color4f(1,1,0,1), 0.75f, 0.35f);
			
		} else if(rotaryAxisDirection == EnumRotaryAxisDirection.Y){
			rotaryAxisArrow = new ArrowRenderer(new Tuple6b(5, 0, 0, u), new Vector3d(0,0,-1), new Vector3d(1,0,0), new Color4f(1,1,0,1), 0.75f, 0.35f);
			
		} else if(rotaryAxisDirection == EnumRotaryAxisDirection.Z){
			rotaryAxisArrow = new ArrowRenderer(new Tuple6b(5, 0, 0, u), new Vector3d(0,-1,0), new Vector3d(1,0,0), new Color4f(1,1,0,1), 0.75f, 0.35f);	
		}
