 ...
 * @date 22 juil. 2017
 */
public class TopPositionOverlay extends AbstractPositionOverlay{
	 ...
	 * @param manager
	 */
	public TopPositionOverlay(OrthographicCamera camera, JoglSceneManager manager) {
		super();
	...
	public void drawPositionData(Graphics2D g2d, Rectangle bounds) throws GkException {
		...
		if(point != null){
			...
			Point4f camera = new Point4f(targetCamera.eye.x, targetCamera.eye.y, 0, 1f);
