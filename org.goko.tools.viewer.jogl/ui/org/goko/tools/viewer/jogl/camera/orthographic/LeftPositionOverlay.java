 ...
 * @date 22 juil. 2017
 */
public class LeftPositionOverlay extends AbstractPositionOverlay{
	 ...
	 * @param manager
	 */
	public LeftPositionOverlay(OrthographicCamera camera, JoglSceneManager manager) {
		super();
	...
	public void drawPositionData(Graphics2D g2d, Rectangle bounds) throws GkException {
		...
		if(point != null){
			...
			Point4f camera = new Point4f(0, targetCamera.eye.y, targetCamera.eye.z, 1f);
