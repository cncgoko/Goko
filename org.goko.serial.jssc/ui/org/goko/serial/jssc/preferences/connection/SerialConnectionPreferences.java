 ...
 *
 */
public class SerialConnectionPreferences extends GkFieldEditorPreferencesPage {
	
	public SerialConnectionPreferences() {
		setDescription("Configure your connection settings");		
		setTitle("Serial");
		setPreferenceStore(JsscSerialActivator.getPreferenceStore());
	}
