...
public class ConfigurationController extends AbstractController<ConfigurationBindings> implements PropertyChangeListener {
	...
	public void refreshMotorConfiguration() throws GkException{
...

		{
			...
			BigDecimal microsteps1 = cfg.getSetting(TinyGConfiguration.MOTOR_4_SETTINGS, TinyGConfiguration.MICROSTEPS, BigDecimal.class);
			getDataModel().setMotor1Microsteps( GkUiUtils.getLabelledValueByKey(microsteps1, getDataModel().getChoicesMicrosteps()) );

			BigDecimal polarityM1 = cfg.getSetting(TinyGConfiguration.MOTOR_4_SETTINGS, TinyGConfiguration.POLARITY, BigDecimal.class);
		...
		}
		{
			...
			BigDecimal microsteps2 = cfg.getSetting(TinyGConfiguration.MOTOR_4_SETTINGS, TinyGConfiguration.MICROSTEPS, BigDecimal.class);
			getDataModel().setMotor2Microsteps( GkUiUtils.getLabelledValueByKey(microsteps2, getDataModel().getChoicesMicrosteps()) );

			BigDecimal polarityM2 = cfg.getSetting(TinyGConfiguration.MOTOR_4_SETTINGS, TinyGConfiguration.POLARITY, BigDecimal.class);
		...
		}
		{
			...
			BigDecimal microsteps3 = cfg.getSetting(TinyGConfiguration.MOTOR_4_SETTINGS, TinyGConfiguration.MICROSTEPS, BigDecimal.class);
			getDataModel().setMotor3Microsteps( GkUiUtils.getLabelledValueByKey(microsteps3, getDataModel().getChoicesMicrosteps()) );

			BigDecimal polarityM3 = cfg.getSetting(TinyGConfiguration.MOTOR_4_SETTINGS, TinyGConfiguration.POLARITY, BigDecimal.class);
	 ...
	 */
	public TinyGControllerService getControllerService() {
		return (TinyGControllerService) controllerService;
	}
