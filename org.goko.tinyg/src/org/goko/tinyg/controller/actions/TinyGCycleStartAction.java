...
/**
 * Cycle start action for TinyG
 *
 * @author PsyKo
 *
 */
public class TinyGCycleStartAction extends AbstractTinyGControllerAction {

	public TinyGCycleStartAction(TinyGControllerService controllerService) {
	...
	public boolean canExecute() throws GkException {
		return ObjectUtils.equals(MachineState.MOTION_HOLDING, getControllerService().getState());
	}
	...
	public void execute(Object... parameters) throws GkException {
		getControllerService().resumeMotion();
	}
