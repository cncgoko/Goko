...
/**
 * Homing action for TinyG
 *
 * @author PsyKo
 *
 */
public class TinyGHomingAction extends AbstractTinyGControllerAction {

	public TinyGHomingAction(TinyGControllerService controllerService) {
