...
public class ExecutionQueue {
	private LinkedBlockingQueue<GCodeStreamedExecutionToken> executionTokens;
	private GCodeStreamedExecutionToken currentToken;

	public ExecutionQueue() {
		executionTokens = new LinkedBlockingQueue<GCodeStreamedExecutionToken>();
	}
	...
	public void add(GCodeStreamedExecutionToken token){
		boolean r = executionTokens.offer(token);
	}
	 ...
	 */
	public GCodeStreamedExecutionToken getCurrentToken() {
		return currentToken;
	}
	...
	public GCodeStreamedExecutionToken waitNext() throws GkException {
		try {
