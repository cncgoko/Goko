...
public class LinearCommandBuilder extends AbstractMotionCommandBuilder<LinearMotionCommand> {
	...
	/** (inheritDoc)
	 * @see org.goko.core.rs274ngcv3.parser.advanced.builders.AbstractMotionCommandBuilder#buildCommand(java.util.Collection, org.goko.core.gcode.bean.GCodeContext, org.goko.core.gcode.bean.commands.MotionCommand)
	 */
	@Override
	...
	/** (inheritDoc)
	 * @see org.goko.core.rs274ngcv3.parser.advanced.builders.AbstractMotionCommandBuilder#match(java.util.Collection, org.goko.core.gcode.bean.GCodeContext)
	 */
	@Override
