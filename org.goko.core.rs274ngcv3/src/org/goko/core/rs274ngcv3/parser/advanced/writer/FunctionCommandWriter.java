...
public class FunctionCommandWriter extends AbstractFunctionCommandWriter<FunctionCommand> {
	 ...
	 */
	@Override
	public String write(FunctionCommand command) throws GkException {
