...
public abstract class AbstractCommentCommandWriter<T extends CommentCommand> extends AbstractRS274CommandWriter<T>{
	...
	/** (inheritDoc)
	 * @see org.goko.core.rs274ngcv3.parser.advanced.writer.AbstractRS274CommandWriter#write(java.lang.String, org.goko.core.gcode.bean.GCodeCommand)
	 */
	@Override
	protected String write(String base, T command) throws GkException {
		String str = base;
		if(command.getLineNumber() != null){
			str = "N"+String.valueOf(command.getLineNumber())+" "+base;
		}
