...
public class BModifier extends LetterTokenCommandModifier<MotionCommand>{
	...
	public void apply(GCodeToken token, MotionCommand command) throws GkException {
		...
		coordinates.setB( NumberQuantity.of(new BigDecimal(RS274.getTokenValue(token)), SI.DEGREE_ANGLE));
