...
public class YModifier extends LetterTokenCommandModifier<MotionCommand>{
	...
	public void apply(GCodeToken token, MotionCommand command) throws GkException {
		...
		coordinates.setY( NumberQuantity.of(new BigDecimal(RS274.getTokenValue(token)), command.getUnit().getUnit()));
