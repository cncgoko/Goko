...
import org.goko.tools.serial.jssc.service.JsscSerialConnection;
...
public class JsscSerialPortConnectionState implements IConnectionListener {
	...
	public void createGui(Composite parent) throws GkException {
		...
		lblConnection.setImage(ResourceManager.getPluginImage("org.goko.tools.serial.jssc", "resources/icons/network-status-offline.png"));
