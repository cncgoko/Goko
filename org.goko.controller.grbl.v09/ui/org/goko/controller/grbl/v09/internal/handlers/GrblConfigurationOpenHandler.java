...
import org.goko.controller.grbl.v09.configuration.GrblConfigurationDialog;
...
public class GrblConfigurationOpenHandler {
	...
	@Execute
	public void execute(@Named(IServiceConstants.ACTIVE_SHELL) Shell shell, IGrblControllerService service, IEclipseContext context) throws GkException {					
