...
public class GrblIntegerSetting extends GrblSetting<Integer> {
	...
	/** (inheritDoc)
	 * @see org.goko.grbl.controller.configuration.GrblSetting#setValueFromString(java.lang.String)
	 */
	@Override
	...
	/** (inheritDoc)
	 * @see org.goko.grbl.controller.configuration.GrblSetting#getValueAsString()
	 */
	@Override
