...
public abstract class JsonValue implements Serializable {
  ...
  /**
   * Returns this JSON value as an <code>BigDecimal</code> value, assuming that this value represents a
   * JSON number that can be interpreted as Java <code>BigDecimal</code>. If this is not the case, an
   * exception is thrown.
   * <p>
   * To be interpreted as Java <code>BigDecimal</code>, the JSON number must neither contain an exponent
   * nor a fraction part. Moreover, the number must be in the <code>Integer</code> range.
   * </p>
   *
   * @return this value as <code>BigDecimal</code>
   * @throws UnsupportedOperationException
   *           if this value is not a JSON number
   * @throws NumberFormatException
   *           if this JSON number can not be interpreted as <code>int</code> value
