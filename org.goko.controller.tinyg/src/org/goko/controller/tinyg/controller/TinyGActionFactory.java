...
import org.goko.controller.tinyg.controller.actions.TinyGSpindleOnCcwAction;
import org.goko.controller.tinyg.controller.actions.TinyGSpindleOnCwAction;
...
public class TinyGActionFactory extends ControllerActionFactory{	
	...
	public void createActions() throws GkException {
		...
		add(new TinyGSpindleOnCwAction(controllerService));
		add(new TinyGSpindleOnCcwAction(controllerService));
