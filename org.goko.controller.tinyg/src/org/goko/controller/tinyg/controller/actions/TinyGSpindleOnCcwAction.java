...
/**
 * Spindle on switching action for TinyG
 *
 * @author PsyKo
 *
 */
public class TinyGSpindleOnCcwAction extends AbstractTinyGControllerAction {

	public TinyGSpindleOnCcwAction(TinyGControllerService controllerService) {
	...
	public boolean canExecute() throws GkException {
		return !ObjectUtils.equals(MachineState.UNDEFINED, getControllerService().getState());//getControllerService().isSpindleOff();
	}
